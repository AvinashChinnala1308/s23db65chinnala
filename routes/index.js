...
//   res.render('index', { title: 'Express : Avinash Chinnala' });
// });
...
res.render('index', { title: 'Organizations App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Organization App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Organization App Login', user : req.user });
});
